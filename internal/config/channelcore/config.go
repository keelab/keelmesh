...
// Config contains process identity, listeners, shutdown, and dependency mode.
...
type Config struct {
	...
	Channels            []Definition        `config:"channels"`
}
...
// Loaded is the initial typed snapshot plus its managed watch runtime.
type Loaded struct {
	Runtime       Config
